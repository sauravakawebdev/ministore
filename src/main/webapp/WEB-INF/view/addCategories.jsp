...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link rel="stylesheet" href="/resources/css/css_addproduct">
    <!-- https://fonts.google.com/specimen/Roboto -->
    <link rel="stylesheet" href="/resources/css/fontawesome.min_addproduct.css">
    <!-- https://fontawesome.com/ -->
    <link rel="stylesheet" href="/resources/js/jquery-ui.min_addproduct.css" type="text/css">
    <!-- http://api.jqueryui.com/datepicker/ -->
    <link rel="stylesheet" href="/resources/css/bootstrap.min_addproduct.css">
    <!-- https://getbootstrap.com/ -->
    <link rel="stylesheet" href="/resources/css/templatemo-style_addproduct.css">
    <!--
    ...
    <nav class="navbar navbar-expand-xl">
      <div class="container h-100">
        <a class="navbar-brand" href="https://technext.github.io/product-admin/index.html">
          <h1 class="tm-site-title mb-0" align="center">Add Categories</h1>
        </a>
          ...
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            ...
            <div class="row tm-edit-product-row">
              <div class="col-xl-6 col-lg-6 col-md-12">
                ...
                <form action="/admin/successCategory" method="post" class="tm-edit-product-form">
                ...
                <%--   <input type="hidden" name="PrdId" value="${product.pId }" /> --%>
                 <%--  <div class="form-group mb-3">
                    <label for="Categories">Category</label>
                    <select class="custom-select tm-select-accounts" id="Categories" name="Categories">
                    <c:forEach items="${Categories}" var="Categorie">
                    	<option value="${Categorie.categoryId }"><c:out value="${Categorie.type }"></c:out></option>
                    </c:forEach>
