...
<div class="row">
  <div class="col-75">
    <div class="container">
      <form action="/chekout_form" method="post">
        ...
        <div class="row">
          <div class="col-50">
			...
			<input type="hidden" id="customerUser" name="customerUser" value="${customerCustomerUsers1.userId }">
            <div class="row">
              <div class="col-50">
  ...
  <div class="col-25">
    ...
    <%--   <c:forEach var="product" items="${products}"> --%>
      <p><a href="/productdetails/${product.pId}">${product.productName }</a> <span class="price">${product.price }</span></p>
     <%--  </c:forEach> --%>
...
<%-- ${customerCustomerUsers1.fullName } --%>
</body>
</html>
